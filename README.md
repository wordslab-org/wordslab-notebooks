...
```bash
apt update && apt install -y curl && export WORDSLAB_HOME=/home/wordslab && export WORDSLAB_WORKSPACE=$WORDSLAB_HOME/workspace && export WORDSLAB_MODELS=$WORDSLAB_HOME/models && export WORDSLAB_VERSION=2026-05 && curl -sSL https://raw.githubusercontent.com/wordslab-org/wordslab-notebooks/refs/tags/$WORDSLAB_VERSION/install-wordslab-notebooks.sh | bash
```
...
```shell
set "WORDSLAB_WINDOWS_HOME=C:\wordslab" && call set "WORDSLAB_VERSION=2026-05" && call curl -sSL https://raw.githubusercontent.com/wordslab-org/wordslab-notebooks/refs/tags/%WORDSLAB_VERSION%/prepare-client-machine.bat -o "%temp%\prepare-client-machine.bat" && call "%temp%\prepare-client-machine.bat"
```

On the client machine, if wordslab-notebooks is already installed :

```shell
set "WORDSLAB_WINDOWS_HOME=C:\wordslab" && call set "WORDSLAB_VERSION=2026-05" && call cd "%WORDSLAB_WINDOWS_HOME%\wordslab-notebooks-%WORDSLAB_VERSION%" && call prepare-client-machine.bat
```
...
```shell
set "WORDSLAB_WINDOWS_HOME=C:\wordslab" && call set "WORDSLAB_VERSION=2026-05" && call cd "%WORDSLAB_WINDOWS_HOME%\wordslab-notebooks-%WORDSLAB_VERSION%" && call prepare-server-secrets.bat
```
...
```shell
set "WORDSLAB_WINDOWS_HOME=C:\wordslab" && call set "WORDSLAB_VERSION=2026-05" && call cd "%WORDSLAB_WINDOWS_HOME%\wordslab-notebooks-%WORDSLAB_VERSION%" && call prepare-server-machine.bat
```
...
The wordslab-notebooks distribution is versioned with version identifiers like '2026-05' (release published in January 2026).
...
Update command (version 2026-05)
...
- the backup date: replace 2026-05-15 with the current date

```shell
wsl --shutdown
"%ProgramFiles%\7-Zip\7z" a -v1g "d:\backups\wordslab-notebooks-2026-05-15.7z" "c:\wordslab\virtual-machines\wordslab-workspace\ext4.vhdx"
```
...
```shell
wsl --shutdown
"%ProgramFiles%\7-Zip\7z" e "d:\backup\wordslab-notebooks-2026-05-15.7z.001" "-oc:\wordslab\virtual-machines\wordslab-workspace\"
```
...
Navigate to the installation directory, for example: *C:\wordslab\wordslab-notebooks-2026-05\windows*.
...
Language models installed by default in wordslab 2026-05 :
