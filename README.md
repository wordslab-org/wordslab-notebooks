...
Update command (version 2025-08)
...
- the backup date: replace 2025-08-15 with the current date

```shell
wsl --shutdown
"%ProgramFiles%\7-Zip\7z" a -v1g "d:\backups\wordslab-notebooks-2025-08-15.7z" "c:\wordslab\virtual-machines\wordslab-workspace\ext4.vhdx"
```
...
```shell
wsl --shutdown
"%ProgramFiles%\7-Zip\7z" e "d:\backup\wordslab-notebooks-2025-08-15.7z.001" "-oc:\wordslab\virtual-machines\wordslab-workspace\"
```
...
Navigate to the installation directory, for example: *C:\wordslab\wordslab-notebooks-2025-08\windows*.
