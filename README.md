...
```shell
set "WORDSLAB_WINDOWS_HOME=C:\wordslab" && call set "WORDSLAB_VERSION=2025-09" && call cd "%WORDSLAB_WINDOWS_HOME%\wordslab-notebooks-%WORDSLAB_VERSION%" && call prepare-server-secrets.bat
```
...
```shell
set "WORDSLAB_WINDOWS_HOME=C:\wordslab" && call set "WORDSLAB_VERSION=2025-09" && call cd "%WORDSLAB_WINDOWS_HOME%\wordslab-notebooks-%WORDSLAB_VERSION%" && call prepare-server-machine.bat
```
...
The wordslab-notebooks distribution is versioned with version identifiers like '2025-09' (release published in September 2025).
...
Update command (version 2025-09)
...
- the backup date: replace 2025-09-15 with the current date

```shell
wsl --shutdown
"%ProgramFiles%\7-Zip\7z" a -v1g "d:\backups\wordslab-notebooks-2025-09-15.7z" "c:\wordslab\virtual-machines\wordslab-workspace\ext4.vhdx"
```
...
```shell
wsl --shutdown
"%ProgramFiles%\7-Zip\7z" e "d:\backup\wordslab-notebooks-2025-09-15.7z.001" "-oc:\wordslab\virtual-machines\wordslab-workspace\"
```
...
Navigate to the installation directory, for example: *C:\wordslab\wordslab-notebooks-2025-09\windows*.
...
Language model installed by default in wordslab 2025-09 : [Google Deepmind Gemma 3](https://deepmind.google/models/gemma/gemma-3/)
